...
const WeatherDetailsPage = () => {
  ...
  const { getCityWeather, getCityForecast, clearError, process, setProcess } = useOpenWeatherServices();
          ...
          <div className="flex justify-between items-center mb-6">
            ...
            <div className="flex flex-col items-center">
              <button
                ...
                className={`flex items-center px-4 py-2 rounded text-white space-x-2 transition-colors ${
                  isSaved
              ...
              <p
                className={`mt-2 text-sm italic h-5 transition-opacity duration-300 ${
